...
enum opt_code
{
  ...
  OPT_fhonour_copts = 693,                   /* -fhonour-copts */
  ...
  OPT_iremap = 1146,                         /* -iremap */
  OPT_isysroot = 1147,                       /* -isysroot */
  OPT_isystem = 1148,                        /* -isystem */
  OPT_iwithprefix = 1149,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1150,              /* -iwithprefixbefore */
  OPT_k8 = 1151,                             /* -k8 */
  OPT_l = 1152,                              /* -l */
  OPT_lang_asm = 1153,                       /* -lang-asm */
  OPT_m128bit_long_double = 1154,            /* -m128bit-long-double */
  OPT_m16 = 1155,                            /* -m16 */
  OPT_m32 = 1156,                            /* -m32 */
  OPT_m3dnow = 1157,                         /* -m3dnow */
  OPT_m3dnowa = 1158,                        /* -m3dnowa */
  OPT_m64 = 1159,                            /* -m64 */
  OPT_m80387 = 1160,                         /* -m80387 */
  OPT_m8bit_idiv = 1161,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1162,             /* -m96bit-long-double */
  OPT_mabi_ = 1163,                          /* -mabi= */
  OPT_mabm = 1164,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1165,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1166,                 /* -maddress-mode= */
  OPT_madx = 1167,                           /* -madx */
  OPT_maes = 1168,                           /* -maes */
  OPT_malign_data_ = 1169,                   /* -malign-data= */
  OPT_malign_double = 1170,                  /* -malign-double */
  OPT_malign_functions_ = 1171,              /* -malign-functions= */
  OPT_malign_jumps_ = 1172,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1173,                  /* -malign-loops= */
  OPT_malign_stringops = 1174,               /* -malign-stringops */
  OPT_mandroid = 1175,                       /* -mandroid */
  OPT_march_ = 1176,                         /* -march= */
  OPT_masm_ = 1177,                          /* -masm= */
  OPT_mavx = 1178,                           /* -mavx */
  OPT_mavx2 = 1179,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1180,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1181,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1182,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1183,                  /* -mavx5124vnniw */
  OPT_mavx512bw = 1184,                      /* -mavx512bw */
  OPT_mavx512cd = 1185,                      /* -mavx512cd */
  OPT_mavx512dq = 1186,                      /* -mavx512dq */
  OPT_mavx512er = 1187,                      /* -mavx512er */
  OPT_mavx512f = 1188,                       /* -mavx512f */
  OPT_mavx512ifma = 1189,                    /* -mavx512ifma */
  OPT_mavx512pf = 1190,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1191,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1192,                      /* -mavx512vl */
  OPT_mavx512vpopcntdq = 1193,               /* -mavx512vpopcntdq */
  OPT_mbionic = 1194,                        /* -mbionic */
  OPT_mbmi = 1195,                           /* -mbmi */
  OPT_mbmi2 = 1196,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1197,                  /* -mbranch-cost= */
  OPT_mcld = 1198,                           /* -mcld */
  OPT_mclflushopt = 1199,                    /* -mclflushopt */
  OPT_mclwb = 1200,                          /* -mclwb */
  OPT_mclzero = 1201,                        /* -mclzero */
  OPT_mcmodel_ = 1202,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1203, */                    /* -mcpu= */
  OPT_mcrc32 = 1204,                         /* -mcrc32 */
  OPT_mcx16 = 1205,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1206,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1207,            /* -mdump-tune-features */
  OPT_mf16c = 1208,                          /* -mf16c */
  OPT_mfancy_math_387 = 1209,                /* -mfancy-math-387 */
  OPT_mfentry = 1210,                        /* -mfentry */
  OPT_mfma = 1211,                           /* -mfma */
  OPT_mfma4 = 1212,                          /* -mfma4 */
  OPT_mforce_drap = 1213,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1214,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1215,                       /* -mfpmath= */
  OPT_mfsgsbase = 1216,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1217,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1218, */              /* -mfused-madd */
  OPT_mfxsr = 1219,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1220,             /* -mgeneral-regs-only */
  OPT_mglibc = 1221,                         /* -mglibc */
  OPT_mhard_float = 1222,                    /* -mhard-float */
  OPT_mhle = 1223,                           /* -mhle */
  OPT_miamcu = 1224,                         /* -miamcu */
  OPT_mieee_fp = 1225,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1226,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1227,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1228,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1229,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1230,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1231, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1232,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1233,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1234,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1235,                /* -mlong-double-80 */
  OPT_mlwp = 1236,                           /* -mlwp */
  OPT_mlzcnt = 1237,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1238,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1239,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1240,                  /* -mmitigate-rop */
  OPT_mmmx = 1241,                           /* -mmmx */
  ...
  OPT_mrdpid = 1267,                         /* -mrdpid */
  OPT_mrdrnd = 1268,                         /* -mrdrnd */
  OPT_mrdseed = 1269,                        /* -mrdseed */
  OPT_mrecip = 1270,                         /* -mrecip */
  OPT_mrecip_ = 1271,                        /* -mrecip= */
  OPT_mrecord_mcount = 1272,                 /* -mrecord-mcount */
  OPT_mred_zone = 1273,                      /* -mred-zone */
  OPT_mregparm_ = 1274,                      /* -mregparm= */
  OPT_mrtd = 1275,                           /* -mrtd */
  OPT_mrtm = 1276,                           /* -mrtm */
  OPT_msahf = 1277,                          /* -msahf */
  OPT_msgx = 1278,                           /* -msgx */
  OPT_msha = 1279,                           /* -msha */
  ...
  OPT_s = 1349,                              /* -s */
  OPT_save_temps = 1350,                     /* -save-temps */
  OPT_save_temps_ = 1351,                    /* -save-temps= */
  OPT_shared = 1352,                         /* -shared */
  OPT_shared_libgcc = 1353,                  /* -shared-libgcc */
  /* OPT_specs = 1354, */                    /* -specs */
  OPT_specs_ = 1355,                         /* -specs= */
  OPT_static = 1356,                         /* -static */
  OPT_static_libasan = 1357,                 /* -static-libasan */
  OPT_static_libgcc = 1358,                  /* -static-libgcc */
